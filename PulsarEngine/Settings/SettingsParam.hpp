...
/*
enum MenuSetting2COLOR {
    MENUSETTING_COLOR_WHITE,
    MENUSETTING_COLOR_BLACK,
    MENUSETTING_COLOR_RED,
    MENUSETTING_COLOR_ORANGE,
    MENUSETTING_COLOR_YELLOW,
    MENUSETTING_COLOR_GREEN,
    MENUSETTING_COLOR_BLUE,
    MENUSETTING_COLOR_PURPLE,
    MENUSETTING_COLOR_PINK,
    MENUSETTING_COLOR_MAGENTA,
    MENUSETTING_COLOR_CYAN,
    MENUSETTING_COLOR_TEAL,
    MENUSETTING_COLOR_GOLD,
    MENUSETTING_COLOR_BROWN,
    MENUSETTING_COLOR_DIAMOND,
	MENUSETTING_COLOR_EMERALD,
    MENUSETTING_COLOR_LAVENDAR,
    MENUSETTING_COLOR_OPTPACK
};*/
...
enum HostSettingGPRACES {
    ...
    HOSTSETTING_GP_RACES_5,
    HOSTSETTING_GP_RACES_6,
    HOSTSETTING_GP_RACES_7,
    HOSTSETTING_GP_RACES_8,
    HOSTSETTING_GP_RACES_9,
    HOSTSETTING_GP_RACES_10,
    HOSTSETTING_GP_RACES_11,
